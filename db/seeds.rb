...
j9 = Journal.create(title: "ER Visit 1", entry: "Waiting for results, swab kit completed, #949504. Social worker will follow up with counseling sessions/aftercare.", user_id: u3.id)
j10 = Journal.create(title: "Police Report 1", entry: "Spoke to Officer Dega, who will follow up with next week. Call 555-555-555 with any new information. Case #90490394.", user_id: u3.id)
j11 = Journal.create(title: "Something Happened 1" , entry: "Woke up somewhere I did not recognize and don't remember much from happened before. Can't find my snake necklace or diamond earrings. No one was around so I had to figure out how to get home. Clothes were torn and had brusies on arms and neck. Decided to go to hospital.", user_id: u3.id)
j12 = Journal.create(title: "Help 1", entry: "I haven't gone out since the incident last weekend. It's only been a week, but I still feel so violated. What if someone drugged me? What if I have HIV? What if it happens again? I feel so out of control. I am spiralling and need help.", user_id: u3.id)
...
p3 = Photo.create(title: "Crow", entry: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Corvus_corone_-near_Canford_Cliffs%2C_Poole%2C_England-8.jpg', user_id: u1.id)
